    ...
    @foreach($orders as $order)
        <div class="sticker-container">
            ...
            <div class="header">
                ...
                <div class="company-info">Premium Jewelry & Accessories</div>
            </div>
            ...
            <div class="items-summary">
                ...
                <div class="item-count">{{ $order->items->count() }} item(s) - ${{ number_format($order->total_amount, 2) }}</div>
            </div>
            ...
            <div class="qr-section">
                ...
                <div style="font-size: 8px; color: #999; word-break: break-all;">
                    {{ $qrCodeUrl }}
                </div>
            </div>
            ...
            <!-- Footer -->
            <div class="footer">
                <div>Handle with care • Premium jewelry inside</div>
                <div>Questions? Contact us at support@yaal.com</div>
            </div>
        </div>
    @endforeach
